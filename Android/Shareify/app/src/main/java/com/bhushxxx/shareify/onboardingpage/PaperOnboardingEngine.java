...
import com.bhushxxx.shareify.BlankFragment;
import com.bhushxxx.shareify.FragmentsActivity;
import com.bhushxxx.shareify.LoginActivity;
...
public class PaperOnboardingEngine implements PaperOnboardingEngineDefaults {
     ...
     */
    public PaperOnboardingEngine(View rootLayout, ArrayList<PaperOnboardingPage> contentElements, final Context appContext) {
